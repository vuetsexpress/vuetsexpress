export const QUOTES = [
  ...
  ["The pawns are the soul of the game.", "François-André Danican Philidor"],
  [
  ...
  [
    "A sport, a struggle for results and a fight for prizes. I think that the discussion about \\",
    " is already inappropriate. The purpose of modern chess is to reach a result.",
  ],
  [
  ...
  [
    "As a rule, so-called \\",
    " sacrifices are considered more difficult, and therefore more praise-worthy than those which are based exclusively on an exact calculation of tactical possibilities.",
  ],
  [
  ...
  [
    "Black's d5-square is too weak.",
    "Ulf Andersson  (on the Dragon variation)",
  ],
  ...
  ["Haste, the great enemy.", "Eugene Znosko-Borowsky"],
  [
  ...
  [
    "He played with enormous energy and great fighting spirit. Offering him a draw was a waste of time. He would decline it politely, but firmly. \\",
    " he would say and the fight would go on and on and on.",
  ],
  [
...
export function randomQuote(limitQuote: number, limitBy: number) {
  const quotes = QUOTES.filter(
    (q) => q[0].length <= limitQuote && q[1].length <= limitBy
  );
